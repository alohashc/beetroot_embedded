# beetroot_embedded — traffic_lights
...
See additional notes in these subfolders:

- [include/README](include/README)
- [lib/README](lib/README)
- [test/README](test/README)

Also see the project copy in `docs`:

- [docs/TRAFFIC_LIGHTS.md](docs/TRAFFIC_LIGHTS.md)
